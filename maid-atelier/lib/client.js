		...
		*/
		function apply(ctx) {
			...
			const syncSettingsBackdropFrame = () => {
				...
				const mask = document.querySelector(SETTINGS_DIALOG_SELECTOR)?.parentElement?.querySelector(SETTINGS_MASK_SELECTOR) ?? null;
