		...
		*/
		function installOrcaPricingLight(body, classes, now = () => /* @__PURE__ */ new Date(), chinese) {
			...
			const syncModel = () => {
				...
				if (modelControl === null) deepSeekModel = true;
				else {
