window.__ModuleLoader__.load({
	id: "@wjingshan/dsh-client-ui-skin-deep-whale-manager",
	factory: (require) => {
		var module = { exports: {} };
		...
		*/
		...
		const tagId = "@wjingshan/dsh-client-ui-skin-deep-whale-manager/skin-manager.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "@wjingshan/dsh-client-ui-skin-deep-whale-manager";
