	...
	factory: (require) => {
		...
		*/
		...
		var skin_manager_module_css_default = {
			...
			"hint": "orL4ja_hint",
			"intro": "orL4ja_intro",
			"introAlt": "orL4ja_introAlt",
			"introHint": "orL4ja_introHint",
			"introName": "orL4ja_introName",
			"introTagline": "orL4ja_introTagline",
		...
		*/
		...
		function skinIntroSource(skin) {
			return {
				key: skin.package,
				name: skin.name,
				...skin.nameEn === void 0 ? {} : { nameEn: skin.nameEn },
				...skin.tagline === void 0 ? {} : { tagline: skin.tagline },
				...skin.taglineEn === void 0 ? {} : { taglineEn: skin.taglineEn },
				...skin.dshCompatibility === void 0 ? {} : { dshCompatibility: skin.dshCompatibility }
			};
		}
		/** The manager's own entry, whose copy lives in the dictionaries rather than a skin.json. */
		function selfIntroSource() {
			return {
				key: MANAGER_PACKAGE,
		...
		*/
		function BundleIntro({ view, intro }) {
			const lang = useUiLang();
			const copy = skinManagerCopy(lang);
			const primary = lang === "en" && intro.nameEn !== void 0 ? intro.nameEn : intro.name;
			const secondary = lang === "en" ? intro.nameEn === void 0 ? void 0 : intro.name : intro.nameEn;
			const tagline = lang === "en" ? intro.taglineEn ?? intro.tagline : intro.tagline;
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				className: skin_manager_module_css_default.intro,
				"data-skin-intro": intro.key,
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", {
						className: skin_manager_module_css_default.introName,
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: primary }), secondary === void 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: skin_manager_module_css_default.introAlt,
							children: secondary
						})]
					}),
					tagline === void 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						className: skin_manager_module_css_default.introTagline,
						children: tagline
					}),
					view === "page" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						className: skin_manager_module_css_default.introHint,
						children: copy.bundleIntroHint
					}) : null,
					view === "page" && intro.dshCompatibility !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						className: skin_manager_module_css_default.introHint,
